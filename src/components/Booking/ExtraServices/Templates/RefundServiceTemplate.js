...
import { ReactComponent as RecommendIcon } from '../../../../assets/media/addictional-services/your-protection.svg';
...
const DesktopIcon = styled(ReturnIcon)`
  @media (max-width: 767px) {
    display: none;
  }
`;
  ...
  return (
    <Wrapper>
      ...
      <Content>
        <Head>
          <Name>
            Гарантия возврата билета <DesktopLabel />
          </Name>
          <Price>{Helper.formatPrice(props.amount)}</Price>
        </Head>
        <MobileHead>
          <MobileHeadLeftSide>
            <ReturnIcon /> <Name>Гарантия возврата билета</Name>
          </MobileHeadLeftSide>
          <Price>{Helper.formatPrice(props.amount)}</Price>
        </MobileHead>
        <Description>
